...
export const mockGuilds: Guild[] = [
  {
    ...
    treasury: {
      gldBalance: 42500,
      resources: [
        { type: 'Clay (tons)', amount: 12, value: 3600 },
        { type: 'Glazes (sets)', amount: 45, value: 9000 },
        { type: 'Kiln Time (hours)', amount: 240, value: 12000 },
      ],
      recentTransactions: [
        {
          id: 'tx-001',
      ...
      allocations: [
        { category: 'Materials', allocated: 15000, spent: 8500 },
        { category: 'Education', allocated: 10000, spent: 3200 },
        { category: 'Events', allocated: 8000, spent: 5500 },
        { category: 'Equipment', allocated: 12000, spent: 2100 },
      ],
    },
    founded: new Date('2023-01-20'),
    description:
  ...
  },
  {
    ...
    memberCount: 189,
    activeProjects: 12,
    tags: ['Sustainability', 'Mixed Media', 'Community'],
    treasury: {
      gldBalance: 28400,
      resources: [],
      recentTransactions: [],
    ...
    description:
      'Artists committed to sustainable practices, ethical sourcing, and environmental consciousness in art-making.',
    members: [],
    projects: [],
    noticeBoard: [],
    isPublic: true,
